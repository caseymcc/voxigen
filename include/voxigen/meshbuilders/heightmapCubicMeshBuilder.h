#ifndef _voxigen_heightCubicMeshBuilder_h_
#define _voxigen_heightCubicMeshBuilder_h_
...
void buildHeightmapCubicMesh(_Mesh &mesh, const std::vector<_Cell> &cells, const glm::ivec2 &cellsSize, const glm::ivec2 &heightRange, size_t lod)
{
...
#endif //_voxigen_heightCubicMeshBuilder_h_