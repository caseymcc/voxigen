#ifndef _voxigen_boundingbox_h_
#define _voxigen_boundingbox_h_
...
public:
    ...
    glm::mat3 rotation()
    {
        return glm::mat3(m_transform[0][0], m_transform[1][0], m_transform[2][0],
