...
public:
    ...
    void create(IGridDescriptors *descriptors, LoadProgress &progress);
    template<typename _FileIO>
    bool load(IGridDescriptors *descriptors, const std::string &directory, LoadProgress &progress);
    template<typename _FileIO>
    ...
    void generateWorldOverview(LoadProgress &progress);
...
private:
    ...
    void generatePlates(LoadProgress &progress);
    void generateContinents(LoadProgress &progress);
