...
#include "imglib/gaussian.h"

namespace imglib{
{

SeparableKernel buildGaussianSeparableKernel(float sigma)
{
...
void gaussian(Image2D &src, ::cl::Image2D &dst, float sigma, Direction direction, float scale,
